...
export const EmploymentTypeEnum = z.enum(["FULL_TIME", "PART_TIME", "CONTRACT", "TEMPORARY", "INTERNSHIP"]);

export const JobStatusEnum = z.enum(["ACTIVE", "CLOSED", "DRAFT", "PAUSED", "ARCHIVED"]);

export const TierEnum = z.enum(["BASIC", "STANDARD", "DREAM"]);
            ...
            questions: z
              .array(
                z.object({
                  ...
                  type: z.enum(["SHORT_TEXT", "LONG_TEXT", "EMAIL", "PHONE", "YES_NO", "CHECKBOX", "MULTIPLE_CHOICE", "DATE", "FILE_UPLOAD", "URL"]),
                  order: z.number().int().min(0, "Order must be a non-negative number"),
