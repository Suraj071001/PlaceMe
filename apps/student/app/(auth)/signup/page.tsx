...
export default function SignupPage() {
    return (
        <div className="flex min-h-screen">
            {/* ── Left branding panel ─────────────────────────────── */}
            <div className="hidden lg:flex lg:w-1/2 flex-col justify-center p-12 bg-gradient-to-b from-emerald-400 to-emerald-600 text-white lg:px-20">
                <div>
                    {/* Graduation cap icon */}
                    <svg
            ...
            <div className="flex w-full items-center justify-center bg-gray-50 px-6 lg:w-1/2">
                <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
                    ...
                    <p className="mb-6 text-sm text-emerald-600">Register as a Student</p>
