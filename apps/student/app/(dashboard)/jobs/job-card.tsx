                ...
                <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="min-w-0 flex-1 space-y-1.5">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span
                                className={`rounded-full border px-2 py-0.5 text-[11px] font-medium leading-none ${job.eligible
                        ...
                        <div className="flex flex-wrap gap-1">
                            {job.skills.map((skill) => (
                                <span
                                    key={skill}
                                    className="rounded bg-gray-900 px-1.5 py-0.5 text-[11px] font-medium text-white"
                                >
                                    {skill}
                                </span>
                            ))}
